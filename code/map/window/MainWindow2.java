...
public class MainWindow2 extends JFrame implements ListSelectionListener {
    ...
    map.login.MainWindow parent;
    MainWindow2 this0 = this;
    User holder;
    JPanel tablePanel;
    ...
    public MainWindow2(map.login.MainWindow parent, User user) throws HeadlessException {
        this.parent = parent;
        holder = user;
        {
//            drawInterface = true;
...
//                        d.drawImage(paper, 0, 0, null);
    ...
    private void closeTable() {
        new Thread() {
            @Override
            public void run() {
                if (isShowTable || isShowUserTable) {
//                    remove(tablePanel);
