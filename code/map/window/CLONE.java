...
public class CLONE extends JFrame implements ListSelectionListener {
    ...
    public CLONE(MainWindow parent, User user) throws HeadlessException {
        this.parent = parent;
        holder = user;
        {
//            drawInterface = true;
...
//            }
    ...
    private DataManager dataManagerT = new DataManager(this0);
...
//                        d.drawImage(paper, 0, 0, null);
    ...
    DefaultTableModel tableModelT = (DefaultTableModel) citiesTable.getModel();
